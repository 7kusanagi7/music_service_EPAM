...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/users-style.css">
</head>
<body>
                    ...
                    <div class="table-responsive">
                        <table class="table user-list table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <th><span><fmt:message key="user.username"/></span></th>
                            ...
                            <c:forEach items="${users}" var="user">
                                <tr>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/profile?userId=${user.id}" class="user-link">${user.firstName} ${user.lastName}</a>
                                        <c:choose>
                                    ...
                                    <td class="text-center">
                                        <form method="POST" action="${pageContext.request.contextPath}/admin/ban-user">
