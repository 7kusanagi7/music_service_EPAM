        ...
        <div class="col-sm-8 col-sm-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="formToValidate" method="post" class="form-horizontal" action="${pageContext.request.contextPath}/register">
                    <input type="hidden" name="command" value="signup">
                    <div class="form-group">
                            <label class="col-sm-4 control-label" for="username"><fmt:message key="user.username"/></label>
                            <div class="col-sm-5 login">
                                <input type="text" class="form-control" name="username" id="username"  placeholder="<fmt:message key="user.username"/>"/>
                            </div>
                        </div>
